...
const svg = d3
  .select("body")
  .append("svg")
  .attr("width", 600) //tree_x)
  .attr("height", 600) //2 * tree_y)
  .append("g")
...
defs
  ...
  .attr("xlink:href", '{{url_for("static", filename="images/Grandma.jpg")}}');
// .attr("onclick", function (d) {
//   `window.href = display/${d.name}`;
// });
